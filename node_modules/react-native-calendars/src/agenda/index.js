...
import { View, Dimensions, Animated,Image,ImageBackground } from 'react-native';
...
export default class Agenda extends Component {
    ...
    renderReservations() {
        ...
        const imgBgr={ uri: "https://i.ibb.co/4dV72qh/pre-Login-Effect-Right-Bottom.png" };
        ...
        return (<View><Image source={imgBgr} style={{width: 82, height: 131, position: 'absolute',right: -20,bottom: 100}}/>
        <ReservationList {...reservationListProps} ref={this.list} selectedDay={this.state.selectedDay} topDay={this.state.topDay} onDayChange={this.onDayChange}/></View>);
    }
    renderCalendarList() {
    ...
    renderKnob() {
        ...
        if (!hideKnob) {
          ...
          <View ref={this.knob} style={{display: 'flex',flexDirection: 'row', alignItems:'center',justifyContent: 'center'}}>{knobView}</View>
